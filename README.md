...
All `PURPLEMET_*` variables from the [configuration reference](https://github.com/Purplemet/cli/wiki/configuration) are supported as environment variables.
...
See the full [GitHub Actions integration guide](https://github.com/Purplemet/cli/wiki/github-actions) for advanced examples, SARIF and Code Scanning setup, security gates, and detailed troubleshooting.
